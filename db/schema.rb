...
ActiveRecord::Schema.define(version: 2019_11_08_084251) do
  ...
  create_table "menu_menu_elements", force: :cascade do |t|
    ...
    t.bigint "menu_element_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["menu_element_id"], name: "index_menu_menu_elements_on_menu_element_id"
    t.index ["menu_id"], name: "index_menu_menu_elements_on_menu_id"
  end
  ...
  add_foreign_key "menu_menu_elements", "menu_elements"
  add_foreign_key "menu_menu_elements", "menus"
